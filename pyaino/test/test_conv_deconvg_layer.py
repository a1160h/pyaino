...
C, Ih, Iw, M, Fh, Fw, stride, pad = 1, 16, 16, 1, 2, 2, 1, 1

# conv_layer = neuron.ConvLayer(M, Fh, Fw, stride, pad)
# deconv_layer = neuron.DeConvLayer(C, Fh, Fw, stride, pad)
conv_layer = neuron.ConvLayer(M, (Fh, Fw), stride, pad) # パラメータを6つに変更
deconv_layer = neuron.DeConvLayer(C, (Fh, Fw), stride, pad) # パラメータを6つに変更
...
# conv_layer = neuron.ConvLayer(M, Fh, Fw, stride, pad, optimize='Adam')
# deconv_layer = neuron.DeConvLayer(C, Fh, Fw, stride, pad, optimize='Adam')
conv_layer = neuron.ConvLayer(M, (Fh, Fw), stride, pad, optimize='Adam') # パラメータを6つに変更
deconv_layer = neuron.DeConvLayer(C, (Fh, Fw), stride, pad, optimize='Adam') # パラメータを6つに変更
