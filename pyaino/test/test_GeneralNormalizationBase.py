...
model = Neuron.BatchNormalization()
model2 = Neuron.batch_normalization()

y = model.forward(x, train=True)
y2 = model2.forward(x, train=True)
...
show_result(x, y, y2, gx, gx2)


#### LayerNormalizationのテスト ####
axis = 1,2,3
