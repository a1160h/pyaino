...
class Diffuser:
    ...
    def denoise(self, model, x, t, t_prev, eta=1.0):
        """ 基本のDDPM """
        t = self.fix_t(t, 1)
    ...
    def denoise_ddpm(self, model, x, t, t_prev, eta=1.0, clip_denoised=False,
    ...
    def sample(self, model, x_shape=(20, 1, 28, 28), x=None,
